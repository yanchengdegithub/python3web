...
if (typeof(Vue)!=='undefined') {
    ...
    Vue.component('pagination', {
        ...
        template: '<ul class="uk-pagination uk-flex-center" uk-margin>' +
                '<li v-if="! has_previous" class="uk-disabled"><span><i uk-icon="icon:chevron-left"></i></span></li>' +
                '<li v-if="has_previous"><a v-on:onclick="\'gotoPage(\' + (page_index-1) + \')\'" href="#0"><i uk-icon="icon:chevron-left"></i></a></li>' +
                '<li class="uk-active"><span v-text="page_index"></span></li>' +
                '<li v-if="! has_next" class="uk-disabled"><span><i uk-icon="icon:chevron-right"></i></span></li>' +
                '<li v-if="has_next"><a v-on:onclick="\'gotoPage(\' + (page_index+1) + \')\'" href="#0"><i uk-icon="icon:chevron-right"></i></a></li>' +
            '</ul>',
        data:function(){
            return this.page;
        }
